...
class BarChartLeaf extends LeafRenderObjectWidget {
  ...
  final BarMaxXCallBack? barMaxXCallBack;
  ...
  RenderBarChart createRenderObject(BuildContext context) => RenderBarChart(
      ...
      offsetX: offsetX, barMaxXCallBack: barMaxXCallBack);
...
class RenderBarChart extends RenderBox {
  RenderBarChart(BarChartData data, BarChartData targetData, double textScale,
      ...
      {double? offsetX, BarMaxXCallBack? barMaxXCallBack})
      : _data = data,
        _targetData = targetData,
        _textScale = textScale,
        _barMaxXCallBack = barMaxXCallBack,
        _offsetX = offsetX ?? 0.0,
        _touchCallback = touchCallback;

  BarMaxXCallBack? _barMaxXCallBack;

  set barMaxCallBack(BarMaxXCallBack value) {
    _barMaxXCallBack = value;
  }
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    _painter.paint(CanvasWrapper(canvas, size), paintHolder,
        offsetX: _offsetX, barMaxXCallBack: _barMaxXCallBack);
    canvas.restore();
  }
